...
```bash
git clone https://github.com/s12samayo/devops-monitoring-project.git
...
* Hands-on use of Git workflows (branching, merging, pull requests)
...
* Add a logging and visualization dashboard
